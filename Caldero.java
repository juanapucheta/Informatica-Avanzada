...
public class Caldero {
    ...
    public Boolean verificarIngredientes () {
        return getIngredientesFaltantes().isEmpty();
    }
    ...
    public void prepararPocima () {
        if (receta != null && verificarIngredientes()){
            ...
            System.out.println(nombre + ": No se puede preparar la pocima");
        }
    ...
    public String toString() {
        if(receta != null){
            return nombre + ": Receta " + receta.getNombre();
        }
        
        else if(pocima != null){
            return nombre + ": " + pocima; 
        }
